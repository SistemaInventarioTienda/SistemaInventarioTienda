  ...
  transformConfig: {
    ...
    DSC_TELEFONO: (item) =>
      item.numberSuppliers?.length > 0
        ? formatPhoneNumber(item.numberSuppliers[0].DSC_TELEFONO)
        : "Sin Información",
    DSC_CORREO: (item) =>
