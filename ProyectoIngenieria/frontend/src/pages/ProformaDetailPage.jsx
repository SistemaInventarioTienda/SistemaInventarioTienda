...
export default function ProformaDetailPage() {
  ...
  if (!proforma) {
    return (
      <div className="loading-container">Cargando detalle de proforma...</div>
    );
  }
      ...
      <div className="proforma-page">
        <div className="proforma-header-actions">
          <button className="btn-back" onClick={handleBack}>
            <ArrowLeft size={16} style={{ marginRight: 6 }} /> Volver al
            historial
          </button>
          <div className="proforma-header-buttons">
            ...
            <button className="primary-btn" onClick={handleConvertToSale}>
              <ShoppingCart size={16} style={{ marginRight: 6 }} /> Convertir a
              venta
            </button>
          </div>
        </div>
        ...
        <div id="print-area" className="proforma-document">
            ...
            <div className="company-section">
              ...
              <div className="company-info">
                <h2 className="company-name">
                  {proforma.Config?.DSC_NOMBRE || "Tienda"}
                </h2>
                <p className="company-slogan">
                  {proforma.Config?.DSC_SLOGAN || ""}
                </p>
            ...
            <div className="proforma-section">
              ...
              <div className="proforma-details">
                ...
                <p>
                  ...
                  {reverseDate(proforma.FEC_LIMITE)}
                </p>
              </div>
              <div
                className={`status-badge ${new Date(proforma.FEC_LIMITE) < new Date() ? "expired" : "valid"}`}
              >
                {new Date(proforma.FEC_LIMITE) < new Date()
                  ? "Vencida"
                  : "Válida"}
              </div>
            </div>
          ...
          <div className="client-section">
            ...
            <div className="client-info">
              <p className="client-type">
                {proforma.Cliente?.TIPO_CLIENTE || "Cliente general"}
              </p>
              <p className="client-note">
                {proforma.Cliente?.NOTA ||
                  "No se especificó información del cliente"}
              </p>
            </div>
          </div>
          ...
          <div className="document-footer">
            <p className="validity-text">
              Esta proforma es válida hasta el{" "}
              {new Date(proforma.FEC_LIMITE).toLocaleDateString("es-CR")}
            </p>
