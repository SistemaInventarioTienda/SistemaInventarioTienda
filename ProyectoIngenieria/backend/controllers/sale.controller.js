import { sale, details } from "../models/sale.model.js";
...
export const createSale = async (req, res) => {
    const { ID_CLIENTE, PORCENT_IMPUESTO, METODO_PAGO, DSC_VENTA, ESTADO_CREDITO, MONT_SUBTOTAL, PORCENT_DESCUENTO, details_list } = req.body;
